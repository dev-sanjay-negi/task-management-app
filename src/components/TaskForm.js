        ...
        <Modal.Body>
          <form onSubmit={formik.handleSubmit}>
            <div className="form-group mb-3">
              ...
              ></input>
              {formik.errors.task_title && formik.touched.task_title ? (
                <p className="form-error">{formik.errors.task_title}</p>
              ) : null}
            </div>
            ...
            <div className="form-group mb-3">
              ...
              <textarea
                ...
                className="form-control"
                rows="3"
                placeholder="Enter the additional details or notes about the task"
                value={formik.values.task_desc}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              ></textarea>
              {formik.errors.task_desc && formik.touched.task_desc ? (
                <p className="form-error">{formik.errors.task_desc}</p>
              ) : null}
            </div>
            <div className="form-group mb-3">
              ...
              <input
                ...
                onBlur={formik.handleBlur}
              ></input>
              {formik.errors.task_duedate && formik.touched.task_duedate ? (
                <p className="form-error">{formik.errors.task_duedate}</p>
              ) : null}
            </div>
            <div className="form-group mb-3">
              ...
              {formik.errors.task_priority && formik.touched.task_priority ? (
                <p className="form-error">{formik.errors.task_priority}</p>
              ) : null}
            </div>
            <div className="form-group mb-3">
              ...
              <input
                ...
                type="text"
                className="form-control"
                placeholder="Enter the tags (comma seperated labels or keywords to help organize and classify 
tasks)"
                value={formik.values.task_tags}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              ></input>
              {formik.errors.task_tags && formik.touched.task_tags ? (
                <p className="form-error">{formik.errors.task_tags}</p>
              ) : null}
            </div>
            <div className="form-group mb-3">
              ...
              {formik.errors.task_status && formik.touched.task_status ? (
                <p className="form-error">{formik.errors.task_status}</p>
              ) : null}
            </div>
            ...
            <div className="form-group mb-3">
              ...
              <input
                name="task_assgined_to"
                type="text"
                className="form-control"
                placeholder="Enter the task owner name"
                value={formik.values.task_assgined_to}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              ></input>
